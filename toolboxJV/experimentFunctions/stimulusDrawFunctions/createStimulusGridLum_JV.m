...
for h=1:expProps.numbElements;
        ...
        [offsetX offsetY] = offsetsSquare(h,expProps.distance,expProps.gridWidth, expProps.gridHeight,expProps.lumJitterRange);
        ...
        elseif( typeSelection == ALTERN )
            stimulusScreen = drawSymbol(stimulusScreen, centerX+offsetX, centerY+offsetY, ring*expProps.gridRing);
        end

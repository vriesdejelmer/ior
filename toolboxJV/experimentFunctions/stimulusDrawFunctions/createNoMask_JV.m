...
distance = expProps.distance/expProps.maskDenseFactor;
gridWidth = expProps.gridWidth *expProps.maskDenseFactor + 3;
gridHeight = expProps.gridHeight *expProps.maskDenseFactor;
...
%         
%         [offsetX offsetY] = offsetsSquare(h,distance,gridWidth, gridHeight,expProps.maskJitterRange);

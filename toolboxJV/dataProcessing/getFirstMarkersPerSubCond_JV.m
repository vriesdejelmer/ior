function [ markerData ] = getFirstMarkersPerSubCond_JV( allFixations, experimentMessages,conditions )
    ...
    for( u = 1:length(conditions) )
        ...
        for( v = 1:length(subConditions) )
            ...
            [experimentMessages(messageSelection).markerTimeStamp] - [experimentMessages(messageSelection).synctimeTimeStamp]
